...
*/
namespace FaustUtilities_karplus {

	#if UNITY_EDITOR
    using UnityEditor;

	[CustomEditor(typeof(FaustPlugin_karplus))]
	public class FaustPlugin_Editor: Editor {

		// Initialization of the dsp
		private FaustPlugin_karplus _dsp;
	...
	*/
	public class Faust_Context {
        ...
        const string _dllName = "libFaustPlugin_karplus";
        #elif UNITY_ANDROID
        const string _dllName = "FaustPlugin_karplus";
        #else
