...
*/
namespace FaustUtilities_AudioPluginTest {

	#if UNITY_EDITOR
    using UnityEditor;

	[CustomEditor(typeof(FaustPlugin_AudioPluginTest))]
	public class FaustPlugin_Editor: Editor {

		// Initialization of the dsp
		private FaustPlugin_AudioPluginTest _dsp;
	...
	*/
	public class Faust_Context {
        ...
        const string _dllName = "libFaustPlugin_AudioPluginTest";
        #elif UNITY_ANDROID
        const string _dllName = "FaustPlugin_AudioPluginTest";
        #else
